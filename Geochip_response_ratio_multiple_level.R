...
season = c("Cold_season_1","Hot_season","Cold_season_2")
for (i in 1:3){
  print(season[i])
  print(mean(rr[[i]]$RR))
...
# final version used to plot response ratios. Fig.2c
...
ggsave("figures/response_ratio/percentage_stimulated_4_cat.pdf", dpi = 500, width = 5, height = 2.5) # fig 2d
